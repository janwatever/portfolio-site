/* eslint-disable */
      ...
      import { Box as Box, Fragment as Fragment_1, HtmlEmbed as HtmlEmbed, Link as Link, Slot as Slot, Button as Button, Text as Text, Body as Body, Image as Image, Paragraph as Paragraph, Heading as Heading, Bold as Bold } from "@webstudio-is/sdk-components-react";
import { Collapsible as Collapsible, CollapsibleTrigger as CollapsibleTrigger, CollapsibleContent as CollapsibleContent, Dialog as Dialog, DialogTrigger as DialogTrigger, DialogOverlay as DialogOverlay, DialogContent as DialogContent, DialogClose as DialogClose } from "@webstudio-is/sdk-components-react-radix";
      ...
      export const pageBackgroundImageAssets: string[] =
        ["integrooving2_URUfMVGJJssyvrnLFA0Og.jpg","integrooving3_4hm5Zph34yzEDfWYluYxt.jpg","integrooving1_IjnMvmA4WyrZnCwxaQxQ9.jpg","Integrooving_opd_5F1E8U5sReU-pi9zgpa_M.jpg"]
...
<Box
className={`w-box cry9bxc c1lfjoq7 ct8c5y2 c10zkoym c16xs6ny ct02u4h c1qom380 c1fhkm63 clv8gve c1mcu1jn c9jupbg c158qw7a c12hsjsj c1ru090q c1syziaj c19ffyra cz2aw51 cakjhhm cnqbj7z cx5af4w`}>
<Box
...
{"Developmental log of Integrooving"}
</Paragraph>
</Box>
</Box>
<Box
...
{"The game idea was developed for an assignment for a class in university. "}
</Paragraph>
</Box>
<Box
...
{"You're a CIA agent who has infiltrated a jazzy new world. Your job is to blend in to the funky beats of their society and steal their declaration of independence."}
</Paragraph>
</Box>
</Box>
<Dialog>
<DialogTrigger>
<Box
className={`w-box cry9bxc c1lfjoq7 c1t3frhm c1z0l37u c1ml0hr7 cv2gy63 cxn73lu c5dy17i c1hsfuam cg37ob1 c19wkfj2 colzpbp csx9m2t c9grybw c1yb3n9o cbrrmm8 cuo9dm5 c5egcmi ce02iuh c15hexcm c17mmneu`}>
<Box
...
<Image
src={"/assets/integrooving1_IjnMvmA4WyrZnCwxaQxQ9.jpg"}
optimize={false}
width={1043}
height={590}
className={`w-image`} />
...
<DialogTrigger>
<Box
className={`w-box cry9bxc c1lfjoq7 c1t3frhm c1z0l37u c1ml0hr7 cv2gy63 cxn73lu c5dy17i c1hsfuam cg37ob1 c19wkfj2 colzpbp c5iatq5 c9grybw crv1a4t cbrrmm8 cuo9dm5 c5egcmi ce02iuh c15hexcm c1u99hy4`}>
<Box
className={`w-box c1mcu1jn cbrbvbg c119en8j`} />
</Box>
</DialogTrigger>
...
<Image
src={"/assets/integrooving2_URUfMVGJJssyvrnLFA0Og.jpg"}
optimize={false}
width={1043}
height={590}
className={`w-image`} />
...
<Paragraph
className={`w-paragraph c1llqm3g coyqk5m`}>
{"1. A combo sequence plays at the start of the level."}
{""}
<br />
{""}
{"2. Hit the keys according to the beat in the next bar."}
</Paragraph>
</Box>
</Box>
<Box
...
<Paragraph
className={`w-paragraph c1llqm3g coyqk5m`}>
{"Prompts are written on screen and what you should do to blend in. If you miss a beat, the crowd will stare you down and if there is too many miss beats, results in a game over."}
</Paragraph>
</Box>
</Box>
<Dialog>
<DialogTrigger>
<Box
className={`w-box cry9bxc c1lfjoq7 c1t3frhm c1z0l37u c1ml0hr7 cv2gy63 cxn73lu c5dy17i c1hsfuam cg37ob1 c19wkfj2 colzpbp c19embcm c9grybw c1yb3n9o cbrrmm8 cuo9dm5 c5egcmi ce02iuh c15hexcm cxz9xjl`}>
<Box
className={`w-box c1mcu1jn cbrbvbg c119en8j`} />
</Box>
</DialogTrigger>
...
<Image
src={"/assets/integrooving3_4hm5Zph34yzEDfWYluYxt.jpg"}
optimize={false}
width={1024}
height={585}
className={`w-image`} />
...
<DialogTrigger>
<Box
className={`w-box cry9bxc c1lfjoq7 c1t3frhm c1z0l37u c1ml0hr7 cdsjpcc c3qzgd0 cl8xzcs c1y6imu0 cv2gy63 cxn73lu c5dy17i c1hsfuam cg37ob1 c1vlqdzi colzpbp cy4a7i8 c9grybw c1yb3n9o cbrrmm8 cuo9dm5 c5egcmi ce02iuh cqdj07j`}>
<Box
className={`w-box c1mcu1jn cbrbvbg c119en8j`} />
<Heading
tag={"h2"}
...
<Image
src={"/assets/Integrooving_opd_5F1E8U5sReU-pi9zgpa_M.jpg"}
optimize={false}
width={2584}
height={1547}
className={`w-image`} />
