/* eslint-disable */
      ...
      import { Box as Box, Fragment as Fragment_1, HtmlEmbed as HtmlEmbed, Link as Link, Slot as Slot, Button as Button, Text as Text, Body as Body, Heading as Heading, Paragraph as Paragraph, List as List, ListItem as ListItem, Image as Image } from "@webstudio-is/sdk-components-react";
import { Collapsible as Collapsible, CollapsibleTrigger as CollapsibleTrigger, CollapsibleContent as CollapsibleContent, Dialog as Dialog, DialogTrigger as DialogTrigger, DialogOverlay as DialogOverlay, DialogContent as DialogContent, DialogClose as DialogClose } from "@webstudio-is/sdk-components-react-radix";
      ...
      export const pageBackgroundImageAssets: string[] =
        ["umlaut_banner_p2J994XeYI148wyC30Eys.png","umlaut_opd-1500w_tpvdm9tmjGM0k9eO0INIw.jpg","umlaut_2XNjY4JFTd-C2kqQ9l2K1.gif"]
...
<Box
className={`w-box c1357293 c9jnjeu c1y6imu0 c3qzgd0 czr2pxy c1xzl1u9 cry9bxc ca4qjwu c1cdc69r c13gq7xy c1lfjoq7 c1qyy4dh ct02u4h c17xbrdu`}>
<Box
className={`w-box cry9bxc c1lfjoq7 ct8c5y2 c10zkoym c16xs6ny ct02u4h c1qom380 c1fhkm63 clv8gve c1mcu1jn c1n5srla c158qw7a c12hsjsj c1ru090q c1syziaj c19ffyra cz2aw51 cakjhhm cnqbj7z c1szwbdi`}>
<Box
className={`w-box cauqto8 c1lfjoq7 c10mkqwx c16xs6ny ct02u4h c1mcu1jn cgn90jy chgdsgq`}>
<Heading
tag={"h2"}
className={`w-heading c1dxq9cf c11dowh9 c1qi8d0g c2wmpdl c74kosi c1x4yn0w cuj80l1 c1dhz37v`}>
{"[ Ü ]"}
</Heading>
<Paragraph
className={`w-paragraph coq6ld c3fmn7t c12ho6o0 c1x4yn0w cuj80l1 c10psnxv c1dhz37v`}>
{"Play as a blank slate and gain experience by interacting with the world around."}
{""}
<br />
{""}
{""}
...
<Box
className={`w-box copqmak c10zkoym ct8c5y2 cori9ti c17xbrdu cx6c9kw c174sw29`}>
<Box
className={`w-box cauqto8 c1lfjoq7 c1t3frhm c1z0l37u c1ml0hr7 cv2gy63 cxn73lu c5dy17i c1hsfuam c1d44amg c19wkfj2 colzpbp cr1aip5 c15hexcm`}>
<Box
...
className={`w-html-embed csru8nn c1qyy4dh ct02u4h c10zkoym ct8c5y2 c1kzehto c1olqo6w cczumif cmn9k97 c1lhse4u cksdijt`} />
<Box
className={`w-box c1lxiyww c1mcu1jn c18v2pa2`}>
<Text
className={`w-text c12sm2j2 c1olqo6w cnbspdo cyqk3ni cl7jefz`}>
{"Features"}
</Text>
</Box>
</Box>
<Box
className={`w-box cry9bxc c1lxiyww c16xs6ny c1wt8a7g cn6056e c1117wcl`}>
<List
className={`w-list c1cn3fw9 c16tlm18 c1llqm3g`}>
<ListItem
className={`w-list-item cn3qe2k`}>
{"Interact with NPCs and watch their reaction"}
</ListItem>
<ListItem
className={`w-list-item cn3qe2k`}>
{"Mini-games"}
...
className={`w-box cry9bxc c1lxiyww c16xs6ny c1wt8a7g cn6056e c1117wcl`}>
<List
className={`w-list c1cn3fw9 c16tlm18 c1qi8d0g c18o6g49`}>
<ListItem
className={`w-list-item cn3qe2k`}>
{"Roughly 3 days to come up with a pitch for the game"}
</ListItem>
<ListItem
className={`w-list-item cn3qe2k`}>
{"I was the only person comfortable working with code and implementing the mechanics"}
</ListItem>
<ListItem
className={`w-list-item cn3qe2k`}>
{"No words are allowed to be used in the game (except for the credits portion) as the main theme of the project."}
</ListItem>
</List>
</Box>
</Box>
<Box
className={`w-box cauqto8 c1lfjoq7 c1t3frhm c1z0l37u c1ml0hr7 cv2gy63 cxn73lu c5dy17i c1hsfuam c10gcf41 cc1qqvk colzpbp cr1aip5 c15hexcm`}>
<Box
className={`w-box cn6056e c1117wcl c1lxiyww c18v2pa2 c16xs6ny cry9bxc c1mcu1jn c5m8ase clv8gve`}>
<HtmlEmbed
...
className={`w-box cry9bxc c1lxiyww c16xs6ny c1wt8a7g cn6056e c1117wcl`}>
<List
className={`w-list c1cn3fw9 c16tlm18 c1llqm3g c1ngdwug`}>
<ListItem
className={`w-list-item cn3qe2k`}>
{"Designed game premise"}
</ListItem>
<ListItem
className={`w-list-item cn3qe2k`}>
{"Coded main game play and mini-game mechanics in C#"}
</ListItem>
</List>
</Box>
</Box>
...
<DialogTrigger>
<Box
className={`w-box cry9bxc c1lfjoq7 c1t3frhm c1z0l37u c1ml0hr7 cv2gy63 cxn73lu c5dy17i c1hsfuam cg37ob1 c9dulfm colzpbp c2hnal7 c9grybw crv1a4t cbrrmm8 cuo9dm5 c5egcmi cr1aip5 c15hexcm clt9350`}>
<Box
...
<DialogContent
className={`w-dialog-content c3o13 cry9bxc c1lfjoq7 cd159xo c9xslfs c1kbljlb c1e7helk cavd3zn c1qyy4dh czr2pxy ct02u4h ckrvf1i cbsgcz0`}>
<DialogClose
...
<Image
src={"/assets/umlaut_2XNjY4JFTd-C2kqQ9l2K1.gif"}
width={1200}
className={`w-image`} />
</DialogContent>
</DialogOverlay>
...
<Heading
className={`w-heading c1qyy4dh c1vlqdzi c1qom380 c1llqm3g cl7jefz c2wmpdl ckjkq46`}>
{"One Page Design"}
</Heading>
<Dialog>
<DialogTrigger>
<Box
className={`w-box cry9bxc c1lfjoq7 c1t3frhm c1z0l37u c1ml0hr7 cv2gy63 cxn73lu c5dy17i c1hsfuam cg37ob1 c1vlqdzi colzpbp cn4hdqe c9grybw c1yb3n9o cbrrmm8 cuo9dm5 c5egcmi ce02iuh c15hexcm c13pb5rt`}>
<Box
className={`w-box c1mcu1jn c1jzkadg c1j0g3hk`} />
</Box>
</DialogTrigger>
<DialogOverlay
className={`w-dialog-overlay cjqo3r0 c1k8g20r c1jr65p0 c1025dch c1j77jp8 c3o13 c17oz2g1 c6irwuw cry9bxc c47o47j cw5izhw`}>
<DialogContent
className={`w-dialog-content czr2pxy c3o13 cry9bxc c1lfjoq7 cd159xo c9xslfs c1e7helk cavd3zn c1kbljlb ckrvf1i cbsgcz0`}>
<DialogClose
...
<Image
src={"/assets/umlaut_opd-1500w_tpvdm9tmjGM0k9eO0INIw.jpg"}
className={`w-image`} />
</DialogContent>
</DialogOverlay>
</Dialog>
